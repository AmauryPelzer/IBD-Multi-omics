...
pathwayAnalysis_results <- data.frame(names(pathways.all), pathways_names, probabilities, lengths(pathways.all))
colnames(pathwayAnalysis_results) <- c("EC_code", "name", "probabilities", "count")
...
pathwayAnalysis_results_sorted[which(pathwayAnalysis_results_sorted$probabilities < 0.05),] %>% 
